...
class EditMembers extends React.Component {
  ...
  constructor(props) {
    ...
    this.messages = defineMessages({
      ...
      removeConfirm: {
        ...
        defaultMessage: `Do you really want to remove {name} @{slug} ({email}) from the core contributors of the collective?`,
      },
    });
  ...
  confirmRemoveMember = memberEntry => {
    return window.confirm(this.props.intl.formatMessage(this.messages.removeConfirm, memberEntry.member));
  };
        ...
        <ResetGlobalStyles>
          <Flex mt={2} flexWrap="wrap">
            ...
            <Flex flex="1" justifyContent="space-between" flexWrap="wrap">
              ...
              <StyledButton onClick={() => this.removeMember(index)} mb={2}>
